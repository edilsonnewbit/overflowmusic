...
function isAdminOrAbove(user: AuthUser): boolean {
  return ADMIN_ROLES.has(user.role);
}

function isLeaderOrAbove(user: AuthUser): boolean {
...
/** Pode criar/editar/deletar ensaios e gerenciar setlist */
